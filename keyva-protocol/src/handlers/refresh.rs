...
use keyva_storage::index::refresh_token::AtomicRefreshError;
...
pub async fn handle_refresh(
    ...
    let (new_token, _raw_bytes) = keyva_crypto::generate_api_key(None)?;
    let new_hash = keyva_crypto::sha256(new_token.as_bytes());
