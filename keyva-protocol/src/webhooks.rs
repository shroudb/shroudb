//! Webhook notification infrastructure for Keyva.
//!
...
use keyva_crypto::{HmacAlgorithm, hmac_sign};
...
/// in the `X-Keyva-Signature` HTTP header.
        ...
        for delivery in &deliveries {
            ...
            for attempt in 0..=delivery.max_retries {
                ...
                match client
                    ...
                    .header("X-Keyva-Signature", &delivery.signature)
