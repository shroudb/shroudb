...
use clap::Parser;
use shroudb_codegen::generator::{Generator, write_output};
use shroudb_codegen::generators::go::GoGenerator;
use shroudb_codegen::generators::python::PythonGenerator;
use shroudb_codegen::generators::ruby::RubyGenerator;
use shroudb_codegen::generators::typescript::TypeScriptGenerator;
use shroudb_codegen::spec::ProtocolSpec;
